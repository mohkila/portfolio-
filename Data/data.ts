export const BaseInfo = {
  name: "dopyapp",
  position: "Full Stack Web Agency",
  description:
...
export const aboutInfo = {
  ...
  description:
    "At dopyapp, we’re a dedicated team of designers and developers committed to delivering tailored web solutions. With a blend of creativity and technical expertise, we help businesses elevate their online presence and achieve their goals",
  client: "150+",
  experience: "9+",
  project: "600+",
  website: "750+",
...
export const contactData = {
  ...
  address: "Amsterdam, Netherlands && cairo",
};
